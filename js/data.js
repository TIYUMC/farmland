...
const DATA = {
  ...
  QUESTS: [
    // —— 主线：里程碑节点（连续一条直线）——
    { id:'root',     parent:null,      x:80,   y:320, icon:'book_purple', title:'初来乍到',   desc:'欢迎来到 Farmland。点击"开始游戏"领取启程物资，开始你的农场之旅。', cat:'core', manual:true, track:{k:'manual'}, reward:{ items:[{id:'hoe', count:1},{id:'water', count:1}], money:5} },
    { id:'a1',       parent:'root',     x:180,  y:320, icon:'dirt',        title:'开垦田地',   desc:'用锄头点击草地或裸土，将其变为耕地。耕地是种植作物的基础。', cat:'core', track:{k:'till', n:1} },
    { id:'m3',       parent:'a1',       x:280,  y:320, icon:'wheat_stage3', title:'初次收获',   desc:'在耕地上播下种子，等待作物成熟（显示饱满麦穗），右键点击收获。', cat:'core', track:{k:'harvest', n:1} },
    { id:'m4',       parent:'m3',       x:380,  y:320, icon:'money',       title:'第一桶金',   desc:'累计赚取 50 金锭，农场初具规模。', cat:'core', track:{k:'earn', n:50} },

    // —— 教程节点（悬浮在主线上方的气泡，描述更丰富）——
    { id:'tut1',     parent:'root',     x:80,   y:220, icon:'bundle_filled', title:'启程礼包', desc:'① 点击开始游戏进入游戏 ② 屏幕中央会出现领取按钮，点击它 ③ 获得初始道具：锄头、浇水壶、5颗小麦种子 ④ 按ESC关闭提示，开始你的农场之旅', cat:'core', manual:true, tutorial:true },
    { id:'tut_hoe',  parent:'root',     x:130,  y:220, icon:'hoe',         title:'锄头使用',   desc:'① 按数字键1选择锄头，或点击底部快捷栏选中 ② 鼠标移到草地上（绿色方块），光标变成锄头图标 ③ 左键点击草地，草地变成泥土（浅棕色） ④ 再次点击泥土，变成耕地（深棕色） ⑤ 耕地才能播种，泥土和草地无法种植', cat:'core', manual:true, tutorial:true },
    { id:'tut_grass',parent:'root',     x:160,  y:220, icon:'grass_block', title:'除草方法',   desc:'① 草地上会长出杂草（黄色小苗） ② 用锄头点击杂草即可清除 ③ 清除杂草需要消耗少量体力 ④ 草地上也可以直接耕地，一次清除杂草变耕地', cat:'core', manual:true, tutorial:true },
    { id:'tut_seed', parent:'a1',       x:180,  y:220, icon:'book_purple', title:'播种方法',   desc:'① 按B打开背包界面 ② 找到小麦种子（在起始礼包里） ③ 将种子拖拽到快捷栏（底部9个格子） ④ 退出背包，选中种子 ⑤ 点击已耕好的土地即可播种 ⑥ 种下的种子第二天开始生长', cat:'core', manual:true, tutorial:true },
    { id:'tut_water',parent:'a1',       x:220,  y:220, icon:'water',       title:'浇水技巧',   desc:'① 按数字键2选择浇水壶，或点击快捷栏选中 ② 鼠标移到已播种的耕地上，光标变成水壶图标 ③ 左键点击耕地进行浇水 ④ 浇水的作物每天多长一个阶段 ⑤ 下雨天会自动给所有耕地浇水，无需操作', cat:'core', manual:true, tutorial:true },
    { id:'tut_harvest',parent:'m3',     x:280,  y:220, icon:'book_purple', title:'收获作物',   desc:'① 作物完全成熟时，麦穗会变得金黄饱满 ② 鼠标移到成熟作物上，光标变成手形 ③ 右键点击作物即可收获 ④ 收获后获得作物果实进入背包 �5 不同作物成熟时间不同，小麦约4天', cat:'core', manual:true, tutorial:true },
    { id:'tut_sell', parent:'m3',       x:320,  y:220, icon:'book_purple', title:'出售赚钱',   desc:'① 按S键打开商店 ② 用鼠标滚轮上下滚动浏览商品列表 ③ 点击你想卖出的作物，它会出现在左侧槽位 ④ 点击交易按钮完成出售，获得金币 ⑤ 也可以直接用右键把背包里的作物卖给商人', cat:'core', manual:true, tutorial:true },
    { id:'tut_craft',parent:'m4',       x:380,  y:220, icon:'book_purple', title:'合成系统',   desc:'① 按B打开背包界面 ② 找到背包左上角的2×2合成格 ③ 将原材料放入合成格，如放入1块原木 ④ 合成格右侧会自动显示成品：4块木板 ⑤ 点击成品即可收入背包，也可继续用木板合成其他物品', cat:'core', manual:true, tutorial:true },
    { id:'tut_wood', parent:'g_tools',  x:580,  y:220, icon:'wooden_axe',  title:'砍伐树木',   desc:'① 按数字键3选择斧头 ② 前往农场西北角的树场 ③ 点击树木，斧头会砍伐树木 ④ 砍倒后获得原木和少量橡果 ⑤ 每次砍伐消耗体力，注意观察体力条', cat:'core', manual:true, tutorial:true },
    { id:'tut_inv',  parent:'a1',       x:250,  y:220, icon:'book_purple', title:'背包操作',   desc:'① 按B键打开背包界面 ② 左键拖拽整堆物品到新位置 ③ 右键点击物品，拿走一半数量 ④ 长按左键并拖拽，可将物品均分到多个空格 ⑤ 底部9个快捷栏可快速切换工具', cat:'core', manual:true, tutorial:true },

    // —— 网关节点（独立放置，不连主线）——
    { id:'g_farm',   parent:null,      x:480,  y:320, icon:'wheat_seeds', title:'▶ 播种耕作', desc:'完成本节点解锁「耕作」支线任务页。', cat:'core', track:{k:'plant', n:1}, manual:true },
    { id:'g_tools',  parent:null,      x:580,  y:320, icon:'wooden_axe',  title:'▶ 置办农具', desc:'完成本节点解锁「工匠」支线任务页。', cat:'core', track:{k:'ownTool', tool:'axe'}, manual:true },
    { id:'g_forage', parent:null,      x:680,  y:320, icon:'oak_log',     title:'▶ 林间初探', desc:'完成本节点解锁「采集」支线任务页。', cat:'core', track:{k:'chop', n:1}, manual:true },
