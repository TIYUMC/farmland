...
const DATA = {
  ...
  QUESTS: [
    ...
    { id:'tut_seed', parent:'a1',       x:260,  y:280, icon:'book_purple', title:'播种方法',   desc:'① 按B打开背包界面 ② 找到小麦种子（在起始礼包里） ③ 将种子拖拽到快捷栏（底部9个格子） ④ 退出背包，选中种子 ⑤ 点击已耕好的土地即可播种 ⑥ 种下的种子第二天开始生长', cat:'core', manual:true, tutorial:true },
    { id:'tut_water',parent:'a1',       x:300,  y:280, icon:'water',       title:'浇水技巧',   desc:'① 按数字键2选择浇水壶，或点击快捷栏选中 ② 鼠标移到已播种的耕地上，光标变成水壶图标 ③ 左键点击耕地进行浇水 ④ 浇水的作物每天多长一个阶段 ⑤ 下雨天会自动给所有耕地浇水，无需操作', cat:'core', manual:true, tutorial:true },
